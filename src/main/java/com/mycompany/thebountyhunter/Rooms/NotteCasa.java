...
public class NotteCasa extends javax.swing.JFrame {

    
    public NotteCasa() {
        initComponents();
        luogo.setText("Casa di Arthur: ingresso dal retro");
    }
    ...
    private void initComponents() {
        ...
        facciatacasa = new javax.swing.JLabel();
        ...
        getContentPane().add(porta, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 550, 720));
        ...
        facciatacasa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/entrataretro.jpg"))); // NOI18N
        getContentPane().add(facciatacasa, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotteCasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotteCasa().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JLabel facciatacasa;
