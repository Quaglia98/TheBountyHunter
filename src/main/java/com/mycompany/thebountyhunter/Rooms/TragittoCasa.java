...
public class TragittoCasa extends javax.swing.JFrame {
        ...
        public void windowOpened(WindowEvent arg0) {
            ...
            SwingWorker<Void, String> worker = new SwingWorker<Void, String>() {
                ...
                protected Void doInBackground() throws Exception {
                    this.publish(new String[]{"E' notte, dovresti tornare a casa"});
                    Thread.sleep(4000);
                    this.publish(new String[]{"Si trova lì di fronte, sulla destra"});
                    Thread.sleep(4000);
                    this.publish("");
                    TragittoCasa.this.casa.setVisible(true);
                    return null;
    ...
    private void initComponents() {
        ...
        casa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/avanzamento.png"))); // NOI18N
        ...
        getContentPane().add(casa, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 250, 60, 90));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/tragittoCasa.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TragittoCasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TragittoCasa().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JButton casa;
