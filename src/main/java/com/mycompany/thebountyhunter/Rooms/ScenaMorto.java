...
public class ScenaMorto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/scenamorto.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScenaMorto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScenaMorto().setVisible(true);
            }
        });
    }
