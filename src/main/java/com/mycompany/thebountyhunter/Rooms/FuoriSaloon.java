...
public class FuoriSaloon extends javax.swing.JFrame {
        ...
        public void windowOpened(WindowEvent arg0) {
            ...
            SwingWorker<Void, String> worker = new SwingWorker<Void, String>() {
                ...
                protected Void doInBackground() throws Exception {
                    this.publish(new String[]{"Dinanzi a te c'è il tuo destriero"});
                    Thread.sleep(4000);
                    this.publish(new String[]{"Un cavallo arabo femmina, nero come la notte"});
                    Thread.sleep(4000);
                    this.publish(new String[]{"Che hai chiamato Notturna"});
                    Thread.sleep(4000);
                    this.publish("");
    ...
    public FuoriSaloon() {
        ...
        this.luogo.setText("Uscita Saloon");
    ...
    private void initComponents() {
        ...
        feed.setBackground(new java.awt.Color(51, 102, 255));
        feed.setFont(new java.awt.Font("Calibri", 3, 12)); // NOI18N
        feed.setText("Dai da mangiare");
        feed.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                feedActionPerformed(evt);
            }
        });
        getContentPane().add(feed, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 220, 130, -1));

        ride.setBackground(new java.awt.Color(255, 0, 51));
        ride.setFont(new java.awt.Font("Calibri", 3, 12)); // NOI18N
        ride.setText("Monta a cavallo");
        ride.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rideActionPerformed(evt);
            }
        });
        getContentPane().add(ride, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 220, 130, -1));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Room2.jpg"))); // NOI18N
    ...
    private void feedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_feedActionPerformed
        this.text.setText("Non hai mangime per il cavallo, dovrai comprarlo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FuoriSaloon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FuoriSaloon().setVisible(true);
            }
        });
    }
