...
public class Fortino extends javax.swing.JFrame {
        ...
        public void windowOpened(WindowEvent arg0) {
            ...
            SwingWorker<Void, String> worker = new SwingWorker<Void, String>() {
                ...
                protected Void doInBackground() throws Exception {
                    this.publish(new String[]{"Hai atteso la notte, e ti sei liberato dalle guardie"});
                    Thread.sleep(5000);
                    this.publish(new String[]{"Bronte è isolato ed è fuori l'abitazione"});
                    Thread.sleep(5000);
                    this.publish(new String[]{"E' la giusta occasione per farlo fuori"});
                    Thread.sleep(5000);
                    this.publish(new String[]{"Sparalo con il tuo fucile di precisione e non fallire"});
                    this.publish("");
                    goScene(thisroom);
                    return null;
    ...
    private void initComponents() {
        ...
        getContentPane().add(satchel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 530, -1, -1));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/fortino.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fortino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
