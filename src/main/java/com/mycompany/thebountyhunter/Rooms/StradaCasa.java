...
public class StradaCasa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        caligahall = new javax.swing.JButton();
        ...
        getContentPane().add(satchel, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 580, -1, -1));
        ...
        getContentPane().add(north, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 320, 120, 70));
        ...
        getContentPane().add(east, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 440, 180, 100));

        caligahall.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/sign.png"))); // NOI18N
        caligahall.setBorderPainted(false);
        caligahall.setContentAreaFilled(false);
        caligahall.setFocusPainted(false);
        caligahall.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                caligahallActionPerformed(evt);
            }
        });
        getContentPane().add(caligahall, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, 200, 250));
        ...
        luogo.setText("Orleans St.");
        luogo.setOpaque(true);
        getContentPane().add(luogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 260, 90));

        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Strada_Casa.jpg"))); // NOI18N
    ...
    private void caligahallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_caligahallActionPerformed
        if(findObject(Posta.messaggioposta)>=0){
        goWest(this);
        }
        else{
            JOptionPane.showMessageDialog(this, "Prima devi recuperare la lettera in posta", "errore", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_caligahallActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StradaCasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StradaCasa().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton caligahall;
