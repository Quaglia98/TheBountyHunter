...
public class GiornoCasa extends javax.swing.JFrame {
        ...
        public void windowOpened(WindowEvent arg0) {
            ...
            SwingWorker<Void, String> worker = new SwingWorker<Void, String>() {
                ...
                protected Void doInBackground() throws Exception {
                    this.publish(new String[]{"E' proprio una bella giornata"});
                    Thread.sleep(3500);
                    this.publish(new String[]{"Orleans St. è già molto trafficata"});
                    Thread.sleep(3500);
                    this.publish("");
                    GiornoCasa.this.strada.setVisible(true);
                    return null;
    ...
    public GiornoCasa() {
        initComponents();
        luogo.setText("Casa di Arthur: ingresso principale");
        addWindowListener(l);
        strada.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        strada = new javax.swing.JButton();
        ...
        getContentPane().add(satchel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 540, -1, -1));

        strada.setBorderPainted(false);
        strada.setContentAreaFilled(false);
        strada.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                stradaActionPerformed(evt);
            }
        });
        getContentPane().add(strada, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 210, 290));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Entrata.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiornoCasa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GiornoCasa().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton strada;
