...
public class Market extends javax.swing.JFrame {
   ...
   WindowListener l = new WindowListener() {
        ...
        public void windowOpened(WindowEvent arg0) {
            ...
            SwingWorker<Void, String> worker = new SwingWorker<Void, String>() {
                ...
                protected Void doInBackground() throws Exception {
                    this.publish(new String[]{"Venditore: Buongiorno Signore, vuole comprare del cibo?"});
                    Thread.sleep(4000);
                    this.publish("");
    ...
    public Market() {
        ...
        luogo.setText("Market Saint Denis");
        addWindowListener(l);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(satchel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 550, -1, -1));

        compra.setBackground(new java.awt.Color(51, 0, 255));
        compra.setFont(new java.awt.Font("Calibri", 3, 14)); // NOI18N
        compra.setForeground(new java.awt.Color(255, 51, 0));
        ...
        getContentPane().add(compra, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, -1, -1));
        ...
        getContentPane().add(uscita, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 590, -1, -1));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Market.jpg"))); // NOI18N
