...
public class EntrataMarket extends javax.swing.JFrame {


    public EntrataMarket() {
        initComponents();
        luogo.setText("Entrata Market Saint Denis");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(satchel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 550, -1, -1));
        ...
        getContentPane().add(west, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 510, 160, 90));
        ...
        getContentPane().add(entrata, new org.netbeans.lib.awtextra.AbsoluteConstraints(401, 240, 510, 440));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/entratamarket.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntrataMarket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EntrataMarket().setVisible(true);
            }
        });
    }
