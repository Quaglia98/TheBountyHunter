...
public class Salone extends javax.swing.JFrame {

  
    public Salone() {
        initComponents();
        luogo.setText("Casa di Bronte: salone");
        text.setText("Trova Bronte");
    ...
    private void initComponents() {
        ...
        salariunioni = new javax.swing.JButton();
        scalinata = new javax.swing.JButton();
        ...
        salariunioni.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/next2.png"))); // NOI18N
        salariunioni.setBorderPainted(false);
        salariunioni.setContentAreaFilled(false);
        salariunioni.setFocusPainted(false);
        salariunioni.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                salariunioniActionPerformed(evt);
            }
        });
        getContentPane().add(salariunioni, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 320, 200, -1));

        scalinata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/next3.png"))); // NOI18N
        scalinata.setBorderPainted(false);
        scalinata.setContentAreaFilled(false);
        scalinata.setFocusPainted(false);
        scalinata.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                scalinataActionPerformed(evt);
            }
        });
        getContentPane().add(scalinata, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, 180, -1));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/salone.png"))); // NOI18N
    ...
    private void salariunioniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salariunioniActionPerformed
        goEast(this);
    }//GEN-LAST:event_salariunioniActionPerformed

    private void scalinataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scalinataActionPerformed
        goWest(this);
    }//GEN-LAST:event_scalinataActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Salone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton salariunioni;
    private javax.swing.JButton satchel;
    private javax.swing.JButton scalinata;
