...
public class MorteBandito extends javax.swing.JFrame {
        ...
        public void windowOpened(WindowEvent arg0) {
            ...
            SwingWorker<Void, String> worker = new SwingWorker<Void, String>() {
                ...
                protected Void doInBackground() throws Exception {
                    this.publish(new String[]{"E' stata una lotta estenuante"});
                    Thread.sleep(4000);
                    this.publish(new String[]{"Ma alla fine hai avuto la meglio"});
                    Thread.sleep(4000);
                    this.publish(new String[]{"Saccheggia il cadavere, e prosegui verso la posta"});
                    Thread.sleep(4000);
                    this.publish("");
                    saccheggia.setVisible(true);
                    return null;
                }
    ...
    int soldirubati, totale;

    public MorteBandito() {
        initComponents();
        saccheggia.setVisible(false);
    ...
    private void initComponents() {
        ...
        saccheggia = new javax.swing.JButton();
        ...
        saccheggia.setFont(new java.awt.Font("Calibri", 3, 18)); // NOI18N
        saccheggia.setForeground(new java.awt.Color(255, 51, 0));
        saccheggia.setText("SACCHEGGIA");
        saccheggia.setBorderPainted(false);
        saccheggia.setContentAreaFilled(false);
        saccheggia.setFocusPainted(false);
        saccheggia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                saccheggiaActionPerformed(evt);
            }
        });
        getContentPane().add(saccheggia, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 340, 170, 90));

        north.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/avanzamento.png"))); // NOI18N
        ...
        getContentPane().add(north, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 30, -1, -1));
        ...
        sfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/mortebandito.jpg"))); // NOI18N
    ...
    private void saccheggiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saccheggiaActionPerformed
        soldirubati = (int) ((Math.random() * ((500 - 100) + 1)) + 100);
        totale = Accesso.p.getSoldi() + soldirubati;
        Accesso.p.setSoldi(totale);
        MenuUscita.soldigiocatore.setText("Soldi: $" + valueOf(totale));
        saccheggia.setVisible(false);
        text.setText("Hai rubato al bandito: $" + valueOf(soldirubati));
    ...
    }//GEN-LAST:event_saccheggiaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MorteBandito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MorteBandito().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton saccheggia;
